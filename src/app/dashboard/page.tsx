...
export default function DashboardPage() {
  ...
  const submitChecklist = async () => {
    ...
    const { data: prop } = await supabase.from("proposals").insert({s
