...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", color: C.text, background: C.bg, transition: "background 0.3s" }}>
        ...
        <div style={{ maxWidth:1100,margin:"0 auto",padding:"0 24px",display:"flex",flexWrap:"wrap",alignItems:"center",gap:48 }}>
          <div style={{ flex:"1 1 500px",color:"#fff" }}>
            ...
            <div style={{ display:"flex",flexWrap:"wrap",gap:14 }}>
              <a href="/signup" style={{ padding:"16px 32px",borderRadius:12,background:C.primary,color:"#1A1A1A",fontSize:16,fontWeight:700,textDecoration:"none",boxShadow:"0 4px 24px rgba(242,183,5,0.35)" }}>Criar conta grátis</a>
              <a href="#comofunciona" style={{ padding:"16px 32px",borderRadius:12,background:"rgba(255,255,255,0.08)",color:"#fff",border:"1.5px solid rgba(255,255,255,0.2)",fontSize:16,fontWeight:700,textDecoration:"none" }}>Ver como funciona</a>
            </div>
      ...
      <section id="comofunciona" style={{ padding:"80px 24px",background:C.bg }}>
        <div style={{ maxWidth:1100,margin:"0 auto" }}>
          <div style={{ textAlign:"center",marginBottom:48 }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(260px, 1fr))",gap:20 }}>
            {[
              ...
              <div key={i} style={{ padding:28,background:p.featured?"#1A1A1A":C.card,borderRadius:18,border:p.featured?`2px solid ${C.primary}`:`1px solid ${C.border}`,position:"relative",boxShadow:p.featured?"0 8px 30px rgba(242,183,5,0.2)":"none" }}>
                ...
                <a href="/signup" style={{ display:"block",width:"100%",padding:"14px 0",borderRadius:10,background:p.outline?"transparent":C.primary,color:p.outline?C.text:"#1A1A1A",border:p.outline?`2px solid ${C.border}`:"none",fontSize:14,fontWeight:700,cursor:"pointer",marginTop:20,textDecoration:"none",textAlign:"center",boxSizing:"border-box" }}>{p.cta}</a>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding:"80px 24px",background:"#1A1A1A",textAlign:"center",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:600,margin:"0 auto",position:"relative",zIndex:1 }}>
          ...
          <a href="/signup" style={{ display:"inline-block",padding:"16px 36px",borderRadius:12,background:C.primary,color:"#1A1A1A",fontSize:16,fontWeight:700,textDecoration:"none",boxShadow:"0 4px 24px rgba(242,183,5,0.35)" }}>Criar conta grátis</a>
        </div>
      </section>
